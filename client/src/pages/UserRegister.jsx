  ...
  return (
    <>
      <style>{`
        ...
        .ur-input { width: 100%; background: rgba(255,255,255,0.03); border: 1px solid rgba(201,147,58,0.15); color: #f5ede0; font-family: 'Barlow', sans-serif; font-size: 14px; padding: 13px 16px; outline: none; box-sizing: border-box; transition: border-color 0.2s; }
        ...
        <div className="ur-card">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="ur-field">
              ...
              <input className="ur-input" type="password" value={form.password} onChange={e => setForm({...form, password:e.target.value})} required placeholder="Minimum 6 characters" minLength={6} />
            </div>
            <div className="ur-field">
              <label className="ur-label">Confirm Password</label>
              <input className="ur-input" type="password" value={form.confirm} onChange={e => setForm({...form, confirm:e.target.value})} required placeholder="Repeat your password" />
            </div>
